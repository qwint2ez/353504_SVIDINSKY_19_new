...
from . import views
from .views import (
    HomeView, MenuView, PizzaDetailView, PizzaCreateView, PizzaUpdateView, PizzaDeleteView,
    OrderCreateView, ReviewCreateView, OrdersListView, MyOrdersView, CouriersListView,
    ProductDetailView, CartView, PaymentView, add_to_cart
)
